...
- `CROCUS__APIS__ICANHAZDADJOKE__HOST` -
  host of the icanhazdadjoke API
  (default: `icanhazdadjoke.com`)
- `CROCUS__APIS__ICANHAZDADJOKE__PATH` -
  path of the icanhazdadjoke API
  (default: ``)
- `CROCUS__APIS__ICANHAZDADJOKE__PORT` -
  port of the icanhazdadjoke API
  (default: ``)
- `CROCUS__APIS__ICANHAZDADJOKE__SCHEME` -
  scheme of the icanhazdadjoke API
  (default: `https`)
- `CROCUS__APIS__SCORPION__HOST` -
  host of the scorpion API
  (default: `localhost`)
- `CROCUS__APIS__SCORPION__PATH` -
  path of the scorpion API
  (default: ``)
- `CROCUS__APIS__SCORPION__PORT` -
  port of the scorpion API
  (default: `20001`)
- `CROCUS__APIS__SCORPION__SCHEME` -
  scheme of the scorpion API
  (default: `http`)
- `CROCUS__DEBUG` -
  enable debug mode
  (default: `true`)
...
- `CROCUS__URLS__ORCHID__HOST` -
  ...
  (default: `localhost`)
- `CROCUS__URLS__ORCHID__PATH` -
  path of the public URL of the orchid app
  (default: ``)
- `CROCUS__URLS__ORCHID__PORT` -
  port of the public URL of the orchid app
  (default: `20120`)
- `CROCUS__URLS__ORCHID__SCHEME` -
