import type {
  DecryptLoginDenyResponseInput,
  DecryptLoginDenyResponseOutput,
} from "./types";
...
export async function decryptLoginDenyResponse({
  data,
}: DecryptLoginDenyResponseInput): Promise<DecryptLoginDenyResponseOutput> {
